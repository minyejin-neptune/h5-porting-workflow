...
def main():
    ...
    arg_parser.add_argument("--mode", choices=["verify", "scan-void", "scan-callers"], default="verify",
                            help="verify: 메서드 호출 가드 검증 (기본) / scan-void: WebGL 공백 체인 탐지 / scan-callers: 래퍼 호출부 역추적")
